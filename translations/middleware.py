...
class LanguageMiddleware:
    ...
    def __call__(self, request):
        ...
        if request.path.startswith('/admin/') or request.path.startswith('/client_messages/') or request.path.startswith('/ckeditor5/') or request.path.startswith('/mediafiles/'):
